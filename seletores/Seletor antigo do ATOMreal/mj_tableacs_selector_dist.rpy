...
init -99 python in mas_selspr:
    ...
    PROMPT_MAP["table_acs"] = {
        ...
        "_min-items": 1,
        "change": "Pode colocar algo diferente na mesa?",
        "wear": "Você pode colocar algo na mesa?",
    }
...
label mj_table_acs_select:
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox("O que você quer que eu coloque na mesa?")
        sel_map = {}
