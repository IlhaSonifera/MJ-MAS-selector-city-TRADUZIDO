...
init -99 python in mas_selspr:
    ...
    PROMPT_MAP["bodytattoo_acs"] = {
        ...
        "_min-items": 1,
        "change": "Pode mudar sua tatuagem de corpo?",
        "wear": "Você pode usar uma tatuagem de corpo?",
    }
...
label mj_bodytattoo_acs_select:
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox("Qual tatuagem você gostaria que eu tivesse?")
        sel_map = {}
